...
export const SocialNetworkSpotImg = styled.image<{ $mouseOver: boolean; $regular: string; $hover: string; $isDesktopOrLaptop: boolean; $isMobileDevice: boolean; $isSmallMobileDevice: boolean }>`
	...
	background-image: url(${({ $mouseOver, $hover, $regular }) => ($mouseOver ? $hover : $regular)});
	&:hover {
