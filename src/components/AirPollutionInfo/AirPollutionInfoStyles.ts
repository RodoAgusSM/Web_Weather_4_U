...
const responsive = {
  ...
  device: (size: 'sm' | 'md' | 'lg' | 'xl') => `@media (min-width: ${responsive.breakpoints[size]})`
};
...
export const ProgressBarContainer = styled.div`
  ...
  &::after {
    ...
    height: 100%;
    background-image: 
      linear-gradient(to right, transparent 19.8%, rgba(255,255,255,0.5) 20%, rgba(255,255,255,0.5) 20.2%, transparent 20.2%),
      linear-gradient(to right, transparent 39.8%, rgba(255,255,255,0.5) 40%, rgba(255,255,255,0.5) 40.2%, transparent 40.2%),
      linear-gradient(to right, transparent 59.8%, rgba(255,255,255,0.5) 60%, rgba(255,255,255,0.5) 60.2%, transparent 60.2%),
      linear-gradient(to right, transparent 79.8%, rgba(255,255,255,0.5) 80%, rgba(255,255,255,0.5) 80.2%, transparent 80.2%);
    pointer-events: none;
  }
`;
