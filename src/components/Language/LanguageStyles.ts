...
export const LanguagesContainer = styled.div<{
	...
	padding: ${({ $isSmallMobileDevice, $useAbbreviatedLabels }) =>
		($isSmallMobileDevice || $useAbbreviatedLabels) ? `${theme.spacing.xs} ${theme.spacing.sm}` : `${theme.spacing.xs} ${theme.spacing.md}`};
	...
	${({ $isTouchDevice, $isSmallMobileDevice }) => $isTouchDevice && !$isSmallMobileDevice && `
