  ...
  useEffect(() => {
    ...
    const updateResponsiveInfo = () => {
      ...
      const mobileKeywords =
        /iphone|ipod|android|blackberry|windows\s+phone|opera\s+mini|iemobile/i;
      ...
      const isMobileDevice =
        ...
        isLargePhoneInLandscape ||
        (isMobileUserAgent && !isTabletUserAgent);
      const isTabletDevice =
        (width >= breakpoints.md && width < breakpoints.lg && !isLargePhoneInLandscape) ||
        isTabletUserAgent;
