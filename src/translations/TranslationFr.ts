export const TranslationFr = {
  ...
  socialNetworks: {
    myInfo: {
      ...
      likeAndView:
        'Si vous avez aimé mon application, je vous invite à visiter mes réseaux sociaux.',
    },
  ...
  errors: {
    errorFetchingSuggestions:
      "Erreur réseau : une erreur s'est produite lors de la récupération des suggestions. Veuillez réessayer plus tard",
  },
};
